...
export default function ConsultarClienteVenda({navigation}){
    ...
    return(
        <View style={estilos.container}>
            ...
            <Text style={estilos.txt1}>Consultar Clientes Venda</Text>
        ...
        onPress={() => navigation.navigate('Consultar Cliente Venda 2')} 
            />
            </SafeAreaView>
